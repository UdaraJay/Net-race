...
In a sense, the intrepretor runs a limited physics simulation. The way different parameters act on each other, and how it defines performance on the track.

In the simplest sense, the intrepretor is called for every car at every frame, in each lap. It outputs how long it takes for the car to get through the frame given all the parameters.
